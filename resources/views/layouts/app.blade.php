...
<head>
    ...
    <title>{{ config('app.name', 'Cash-Cenverters') }}</title>
    <!-- Scripts -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li><a class="nav-link" href="{{ route('categories-list') }}">Categorias</a></li>
                        @can('role-list')
                            <li><a class="nav-link" href="{{ route('users-list') }}">Listado de Usuarios</a></li>
                        @endcan
